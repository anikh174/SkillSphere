            ...
            <div className=' flex items-center p-5 lg:p-20 gap-10 flex-col-reverse md:flex-row justify-center container mx-auto'>
                <div className='text-center space-y-4 lg:space-y-8'>
                    ...
                    <div className='space-y-3 lg:space-y-5'>
                        <h3 className='text-2xl md:text-3xl lg:text-5xl font-bold text-white'>Upgrade Your Skills <span className='text-blue-200'>Today</span></h3>
                    ...
                    <div className='flex gap-2 justify-center'>
                        <button className='btn flex items-center gap-1 text-orange-400'><TbWorld className='h-5 w-5'/>Browse Courses</button>
                        <button className='btn flex items-center gap-1 text-orange-400'><FaPlay />Watch Demo</button>
                    </div>
                </div>
