        ...
        <div className="text-white mx-5">
          ...
          <div className="flex flex-col md:flex-row justify-center md:gap-10 lg:gap-20 mt-8">
            <div className="flex flex-col gap-5">
              <div className="space-y-1 bg-purple-600 p-2 rounded-2xl border-b-5 border-l-10 border-purple-300 shadow-sm shadow-purple-300">
              ...
              <div className="space-y-1 bg-yellow-800 p-2 rounded-2xl border-l-10 border-b-5 border-yellow-300 shadow-sm shadow-yellow-300">
            ...
            <div className="flex flex-col gap-5 mt-5 md:mt-0">
              <div className="space-y-1 bg-sky-600 p-2 rounded-2xl border-b-5 border-r-10 border-sky-300 shadow-sm shadow-sky-300">
              ...
              <div className="space-y-1 bg-green-700 p-2 rounded-2xl border-b-5 border-r-10 border-green-300 shadow-sm shadow-green-300">
